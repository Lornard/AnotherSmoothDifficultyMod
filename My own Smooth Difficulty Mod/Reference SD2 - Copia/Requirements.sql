...
('REQUIRES_DEMIGOD', 'REQUIREMENT_PLAYER_HANDICAP_AT_OR_ABOVE', 0),
('REQUIRES_NOT_DEMIGOD', 'REQUIREMENT_PLAYER_HANDICAP_AT_OR_ABOVE', 1),
('REQUIRES_DEITY', 'REQUIREMENT_PLAYER_HANDICAP_AT_OR_ABOVE', 0),
('REQUIRES_NOT_DEITY', 'REQUIREMENT_PLAYER_HANDICAP_AT_OR_ABOVE', 1),
('REQUIRES_OMNISCIENT', 'REQUIREMENT_PLAYER_HANDICAP_AT_OR_ABOVE', 0),
('REQUIRES_NOT_OMNISCIENT', 'REQUIREMENT_PLAYER_HANDICAP_AT_OR_ABOVE', 1),
...
('REQUIRES_DEMIGOD', 'Handicap', 'DIFFICULTY_DEMIGOD'),
('REQUIRES_NOT_DEMIGOD', 'Handicap', 'DIFFICULTY_DEMIGOD'),
('REQUIRES_DEITY', 'Handicap', 'DIFFICULTY_DEITY'),
('REQUIRES_NOT_DEITY', 'Handicap', 'DIFFICULTY_DEITY'),
('REQUIRES_OMNISCIENT', 'Handicap', 'DIFFICULTY_OMNISCIENT'),
('REQUIRES_NOT_OMNISCIENT', 'Handicap', 'DIFFICULTY_OMNISCIENT'),
